// Last updated: 30/04/2026, 02:35:18
1class Solution {
2    int n, m;
3    Integer[][][] dp;
4
...
12        }
13
14        if (dp[i][j][bullets] != null) return dp[i][j][bullets];
15
...
46        m = coins[0].length;
47        
48        dp = new Integer[n][m][3]; // assuming max bullets = 2
49
50        return helper(coins, 0, 0, 2);
51    }
52}